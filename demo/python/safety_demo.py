...
tools = [
    ...
    },
    {
        "toolSpec": {
            "name": "search_memory",
            "description": "Search for previously stored information. ALWAYS use this before giving advice about health, food, or activities involving children.",
            "inputSchema": {
                "json": {
                    "type": "object",
                    "properties": {
...
def main():
    ...
    print("  3. Agent retrieved critical safety information")
    print("  4. Agent warned parent about the danger")
    print("\nWithout persistent memory, this could have been life-threatening!")
    print("=" * 70)

    print("\nTechnical Achievement:")
    print("  - Cross-session memory persistence")
    print("  - Semantic search (shrimp -> shellfish allergy)")
    print("  - Proactive safety checking")
